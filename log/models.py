...
class ClubItem(models.Model):
    ...
    director = models.ForeignKey(User, models.CASCADE,related_name='direct_club',verbose_name='社長')
    advisor = models.ForeignKey(User, models.CASCADE,related_name='tutor_club',verbose_name='指導老師')
...
class TransferForm(models.Model):
    ...
    user = models.ForeignKey(User, models.CASCADE,verbose_name='申請人',related_name='form_list')
    date_created = models.DateField('申請時間',auto_now_add=True)
    club_orig = models.ForeignKey(ClubItem, models.CASCADE,verbose_name='原社團', related_name='out_form')
    club_new = models.ForeignKey(ClubItem, models.CASCADE,verbose_name='新社團', related_name='in_form')
